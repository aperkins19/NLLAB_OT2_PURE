...
def run(protocol: protocol_api.ProtocolContext):
    ...
    if protocol_dispense_subsrates:
        ...
        for well in ms_dispense_well_list:
            ...
            distribute_substrates(well, pcr_temp_plate['B1'], substrates_aspirate_height)
    ...
    if protocol_dispense_wax:
        ...
        right_pipette.distribute(wax_dispense_volume,
               wax_eppendorf_well,
               [nunc_384.wells_by_name()[well_name].top(wax_dispense_height) for well_name in ms_dispense_well_list],
               new_tip=wax_new_tip,
