...
""
docker build -t cfps_timecourse_analysis_image .
""
...
""
docker run -p 9998:8888 -v "%CD%":/src --name tech_err_timecourse_analysis_container cfps_timecourse_analysis_image
""

If you're on Mac or Linux:

""
docker run -p 8888:8888 -v "%PWD":/src cfps_timecourse_analysis_image 
""
